subroutine readtable(eos_filename,need_to_allocate)
...
!  write(*,*) "WARNING, THE ENERGY SHIFT IS BEING SET TO ZERO!!!!!!!!!!!!!"
!  write(*,*) "WARNING, THE ENERGY SHIFT IS BEING SET TO ZERO!!!!!!!!!!!!"
!  write(*,*) "WARNING, THE ENERGY SHIFT IS BEING SET TO ZERO!!!!!!!!!!!!!"
!  write(*,*) "WARNING, THE ENERGY SHIFT IS BEING SET TO ZERO!!!!!!!!!!!!!"
!  write(*,*) "WARNING, THE ENERGY SHIFT IS BEING SET TO ZERO!!!!!!!!!!!!!"
