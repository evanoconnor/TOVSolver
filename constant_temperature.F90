!-*-f90-*-
subroutine mass_constant_temperature(central_density,temperature, &
  ...
  do i=2,N
     ...
     h = 1.0d0+TOVeps(i)/c**2+TOVpressure(i)/TOVrho(i)/c**2
     X = 1.0d0/sqrt(1.0d0-2.0d0*6.67d-8*TOVmass(i)/(29979245800.0d0**2*TOVrad(i)))
     momentI = momentI + 2.0d0/3.0d0*TOVrho(i)*h*X*TOVrad(i)**2*4.0d0*pi*TOVrad(i)**2*dr
...
end subroutine mass_constant_temperature
